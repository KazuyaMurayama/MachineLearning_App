...
with ft1:
    st.markdown(
        ...
        <h4 style="margin:8px 0 4px 0;">離反予測デモ</h4>
        <p style="color:#64748B;font-size:0.9rem;">AIで顧問先の離反リスクを予測</p>
        <a href="https://shigyou-churn.streamlit.app" target="_blank"
...
with ft2:
    st.markdown(
        ...
        <p style="color:#64748B;font-size:0.9rem;">試算表から自動でレポート生成</p>
