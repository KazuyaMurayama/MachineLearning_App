...
<p>EC事業の売上・顧客・広告を<br>AIで可視化・最適化する 3つの専用ツール</p>
...
with k1:
    st.markdown('<div class="kpi-card"><div class="kpi-value">3</div><div class="kpi-label">専用AIツール</div></div>', unsafe_allow_html=True)
with k2:
...
# Footer
st.markdown("---")
st.caption("EC AIマーケティングパートナー × データサイエンス | v2.0")
