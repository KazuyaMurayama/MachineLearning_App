...
<p>EC事業の売上・顧客・広告を<br>AIで可視化・最適化する 4つの専用ツール</p>
...
with k1:
    st.markdown('<div class="kpi-card"><div class="kpi-value">4</div><div class="kpi-label">専用AIツール</div></div>', unsafe_allow_html=True)
with k2:
...
<div class="card-effect">✨ 月額25万円の伴走支援を可視化</div>
